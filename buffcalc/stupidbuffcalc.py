...
Label(root, text='i really want some food', font=('Arial', 12)).grid(column=4, row=1, columnspan=2) #columnspan means that it wont affect the other stuff
# place the buffs in the grid
for item in allvar:
    for iter in allvar[item]:
        allvar[item][iter].set("0 0 1")
# outputs, self explainatory
Label(root, text="pain level: ", font=("Arial", 12)).grid(column=3, row=8)
Label(root, text="shooty power: ", font=("Arial", 12)).grid(column=3, row=9)
Label(root, text="spray frequency:", font=("Arial", 12)).grid(column=3, row=10)
Label(root, text="uno targeto:", font=("Arial", 12)).grid(column=3, row=11)
...
Label(root, text="pain level:", font=("Arial", 12)).grid(column=5, row=3)
Label(root, text="shooty power:", font=("Arial", 12)).grid(column=5, row=4)
Label(root, text="spray frequency:", font=("Arial", 12)).grid(column=5, row=5)
Label(root, text="the cumulative quantity of projectiles tossed out in a single throw:", font=("Arial", 12)).grid(column=5, row=6)
Label(root, text="pain dished out", font=("Arial", 12)).grid(column=5, row=8)
...
# button stuff
Button(root, text='my output isnt updated god please someone help', bd=3, command=lambda: update('dummy', 'dummy', allupdate=True), font=('Arial', 10)).grid(row=1, column=1, sticky=S)
# checkboxes for buffs
# ordered in [damage, pierce, speed]
Checkbutton(
    root,
    text="pbruh not toxic",
